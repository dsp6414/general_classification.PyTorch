...
from .utils.adaptive_avgmax_pool import SelectAdaptivePool2d
from .utils.conv2d_helpers import select_conv2d
...
def _efficientnet(channel_multiplier=1.0, depth_multiplier=1.0, num_classes=1000, **kwargs):
...
def _efficientnet_edge(channel_multiplier=1.0, depth_multiplier=1.0, num_classes=1000, **kwargs):
    arch_def = [
...
def _mixnet_s(channel_multiplier=1.0, num_classes=1000, **kwargs):
...
def _mixnet_m(channel_multiplier=1.0, depth_multiplier=1.0, num_classes=1000, **kwargs):
...
def _mobilenet_v1(channel_multiplier, num_classes=1000, **kwargs):
...
def _mobilenet_v2(channel_multiplier, num_classes=1000, **kwargs):
...
def _mobilenet_v3(channel_multiplier, num_classes=1000, **kwargs):
...
def mobilenetv1_100(pretrained=False, num_classes=1000, in_chans=3, **kwargs):
    ...
    model = _mobilenet_v1(1.0, num_classes=num_classes, in_chans=in_chans, **kwargs)
    model.default_cfg = default_cfg
    if pretrained:
        load_pretrained(model, default_cfg, num_classes, in_chans)
    return model
...
def mobilenetv2_100(pretrained=False, num_classes=1000, in_chans=3, **kwargs):
    ...
    model = _mobilenet_v2(1.0, num_classes=num_classes, in_chans=in_chans, **kwargs)
    model.default_cfg = default_cfg
    if pretrained:
        load_pretrained(model, default_cfg, num_classes, in_chans)
    return model
...
def mobilenetv3_050(pretrained=False, num_classes=1000, in_chans=3, **kwargs):
    ...
    model = _mobilenet_v3(0.5, num_classes=num_classes, in_chans=in_chans, **kwargs)
    model.default_cfg = default_cfg
    if pretrained:
        load_pretrained(model, default_cfg, num_classes, in_chans)
    return model
...
def mobilenetv3_075(pretrained=False, num_classes=1000, in_chans=3, **kwargs):
    ...
    model = _mobilenet_v3(0.75, num_classes=num_classes, in_chans=in_chans, **kwargs)
    model.default_cfg = default_cfg
    if pretrained:
        load_pretrained(model, default_cfg, num_classes, in_chans)
    return model
...
def mobilenetv3_100(pretrained=False, num_classes=1000, in_chans=3, **kwargs):
    ...
    model = _mobilenet_v3(1.0, num_classes=num_classes, in_chans=in_chans, **kwargs)
    model.default_cfg = default_cfg
    if pretrained:
        load_pretrained(model, default_cfg, num_classes, in_chans)
    return model